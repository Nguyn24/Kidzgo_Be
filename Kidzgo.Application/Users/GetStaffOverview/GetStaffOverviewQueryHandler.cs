...
public sealed class GetStaffOverviewQueryHandler(
    IDbContext context,
    IUserContext userContext)
    : IQueryHandler<GetStaffOverviewQuery, StaffOverviewResponse>
{
    public async Task<Result<StaffOverviewResponse>> Handle(
        GetStaffOverviewQuery query,
