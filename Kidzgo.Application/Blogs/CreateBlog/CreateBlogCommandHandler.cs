...
) : ICommandHandler<CreateBlogCommand, CreateBlogResponse>
{
    public async Task<Result<CreateBlogResponse>> Handle(CreateBlogCommand command, CancellationToken cancellationToken)
    {
        ...
        var blog = new Blog
        {
            ...
            AttachmentImageUrl = command.AttachmentImageUrl,
            AttachmentFileUrl = command.AttachmentFileUrl,
            CreatedBy = createdBy,
            IsPublished = false,
            IsDeleted = false,
            PublishedAt = null,
        ...
        return new CreateBlogResponse
        {
            ...
            AttachmentImageUrl = blogWithNav.AttachmentImageUrl,
            AttachmentFileUrl = blogWithNav.AttachmentFileUrl,
