...
namespace Kidzgo.Infrastructure.Migrations
{
    ...
    [Migration("20260223093316_AddIndexesForMonthlyReportPerformance")]
    partial class AddIndexesForMonthlyReportPerformance
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Kidzgo.Domain.Exams.ExamResult", b =>
                {
                    ...
                    b.HasIndex("StudentProfileId")
                        .HasDatabaseName("exam_result_student_profile_idx");
            ...
            modelBuilder.Entity("Kidzgo.Domain.Gamification.MissionProgress", b =>
                {
                    ...
                    b.HasIndex("StudentProfileId")
                        .HasDatabaseName("mission_progress_student_profile_idx");
            ...
            modelBuilder.Entity("Kidzgo.Domain.LessonPlans.HomeworkStudent", b =>
                {
                    ...
                    b.HasIndex("StudentProfileId")
                        .HasDatabaseName("homework_student_student_profile_idx");
            ...
            modelBuilder.Entity("Kidzgo.Domain.Reports.SessionReport", b =>
                {
                    ...
                    b.HasIndex("StudentProfileId", "ReportDate")
                        .HasDatabaseName("session_report_student_date_idx");
            ...
            modelBuilder.Entity("Kidzgo.Domain.Reports.StudentMonthlyReport", b =>
                {
                    ...
                    b.HasIndex("StudentProfileId", "Month", "Year")
                        .IsUnique();
            ...
            modelBuilder.Entity("Kidzgo.Domain.Sessions.Attendance", b =>
                {
                    ...
                    b.HasIndex("StudentProfileId")
                        .HasDatabaseName("attendance_student_profile_idx");
