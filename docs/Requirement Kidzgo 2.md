...
* **Học phí theo khóa & nhiều lớp**:
  ...
  * Mỗi buổi/điểm danh có phân loại:
    ...
    * EXTRA\_PAID – buổi học thêm/lớp bổ trợ, **tính phí thêm**.

    * FREE/TRIAL – buổi miễn phí/học thử.

  * Hệ thống dùng **đơn giá tham chiếu theo buổi (UnitPrice)** để tính tiền cho EXTRA\_PAID nếu cần, tránh double-charge.
...
*(giữ nguyên phần bạn đã viết về UnitPrice, phân loại MAIN/MAKEUP/EXTRA\_PAID/FREE)*
